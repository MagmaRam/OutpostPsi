...
[Code](http://github.com/MementoVile/OutpostPsi) - based on [Baystation12](https://github.com/Baystation12/Baystation12)
Current map is based on tinystationv3.dmm
...
Click [here](https://github.com/MementoVile/OutpostPsi/archive/master.zip) to get the latest code as a .zip file, then unzip it to wherever you want.

The more complicated and easier to update method is using git.  You'll need to download git or some client from [here](http://git-scm.com/).  When that's installed, right click in any folder and click on "Git Bash".  When that opens, type in:

    git clone https://github.com/MementoVile/OutpostPsi.git
