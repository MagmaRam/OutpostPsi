...
/obj/structure/closet/walllocker/emerglocker
	...
	var/list/spawnitems = list(/obj/item/weapon/crowbar, /obj/item/weapon/tank/emergency_oxygen, /obj/item/clothing/mask/breath)
...
/obj/structure/closet/walllocker/emerglocker/attack_hand(mob/user as mob)
	...
	if(!amount)
		...
		return
	if(amount)
		usr << "<span class='notice'>You take out some items from \the [src].</span>"
