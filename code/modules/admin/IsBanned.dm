...
world/IsBanned(key,address,computer_id)
	...
	//[modules/whitelist] Connect whitelist check
	if (config.use_connect_whitelist && !connect_whitelist.is_whitelisted(key))
		return list("reason"="Not whitelisted", "desc"="\nReason: You are not whitelisted.")

	return ..()	// Default pager stuff
#endif
